...
class TraineeModelTest {
	...
	void toString_shouldReturnExpectedValue_whenInvoked() {
		final TraineeModel trainee =
			new TraineeModel(1L, "firstName", "lastName", "userName",true, 2L, null, "address", new ArrayList<>());
	...
	void testEqualsAndHashCode() {
		...
		final var responseDTO2 =
			new TraineeModel(1L, "FirstName", "LastName", "UserName", true, 2L, new Date(), "Address", new ArrayList<>());
		final var responseDTO3 =
			new TraineeModel(2L, "FirstName", "LastName", "UserName", true, 2L, new Date(), "Address", new ArrayList<>());
		final var responseDTO4 =
			new TraineeModel(1L, "FirstName2", "LastName", "UserName", true, 2L, new Date(), "Address", new ArrayList<>());
		final var responseDTO5 =
			new TraineeModel(1L, "FirstName", "LastName2", "UserName", true, 2L, new Date(), "Address", new ArrayList<>());
		final var responseDTO6 =
			new TraineeModel(1L, "FirstName", "LastName", "UserName2", true, 2L, new Date(), "Address", new ArrayList<>());
		final var responseDTO7 =
			new TraineeModel(1L, "FirstName", "LastName", "UserName", true, 3L, new Date(), "Address", new ArrayList<>());
		final var responseDTO8 =
			new TraineeModel(1L, "FirstName", "LastName", "UserName", true, 2L, new Date(), "Address2", new ArrayList<>());
		final var responseDTO9 =
			new TraineeModel(1L, "FirstName", "LastName", "UserName", true, 2L, new Date(), "Address", List.of(trainer));
