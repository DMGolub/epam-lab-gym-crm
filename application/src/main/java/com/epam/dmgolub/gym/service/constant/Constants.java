package com.epam.dmgolub.gym.service.constant;

public class Constants {

	public static final String TRAINEE_NOT_FOUND_BY_ID_MESSAGE = "Can not find trainee by id=";
	public static final String TRAINEE_NOT_FOUND_BY_USERNAME_MESSAGE = "Can not find trainee by userName=";
