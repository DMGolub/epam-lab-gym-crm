...
public class TrainerServiceImpl implements TrainerService {
	...
	public Credentials save(final TrainerModel request) {
		LOGGER.debug("[{}] In save - Saving trainer from request {}", MDC.get(TRANSACTION_ID), request);
	...
	public List<TrainerModel> findAll() {
		LOGGER.debug("[{}] In findAll - Fetching all trainers from repository", MDC.get(TRANSACTION_ID));
		return mapper.mapToTrainerModelList(trainerRepository.findAll());
	}

	@Override
	public TrainerModel findByUserName(final String userName) {
		LOGGER.debug("[{}] In findByUserName - Fetching trainer by userName={} from repository",
	...
	public TrainerModel update(final TrainerModel request) {
		LOGGER.debug("[{}] In update - Updating trainer from request {}", MDC.get(TRANSACTION_ID), request);
	...
	public List<TrainerModel> findActiveTrainersAssignedOnTrainee(final String userName) {
		LOGGER.debug("[{}] In findActiveTrainersAssignedToTrainee - Fetching assigned trainers for trainee={}",
			MDC.get(TRANSACTION_ID), userName);
	...
	public List<TrainerModel> findActiveTrainersNotAssignedOnTrainee(final String userName) {
		LOGGER.debug("[{}] In findActiveTrainersNotAssignedToTrainee - Fetching not assigned trainers for trainee={}",
			MDC.get(TRANSACTION_ID), userName);
